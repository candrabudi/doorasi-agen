            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a href="{{ route('distributors.create') }}" class="btn btn-primary">
                        <i class="ki-duotone ki-plus fs-2"></i> Add Distributor
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('distributors.edit', $user->id) }}" class="btn btn-sm btn-light-primary me-2">
                                            <i class="ki-duotone ki-pencil fs-5"></i> Edit
                                        </a>
                                        <form action="{{ route('distributors.destroy', $user->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
